...
public class Config {
	...
	public static class Applitools{
        public static final String myApiKey      = ReadPropertytFile().getProperty("appliToolsApiKey");
//        public static final String myApiKey      = "Joqai7yB4nWCypQ7199yBfxOL52Belf5gJAlQrTap1jQ110";
	}
